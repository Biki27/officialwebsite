...
class Manager extends CI_Controller
{
    ...
    public function addProject()
    {
        ...
        // Basic validation
        if (empty($data['projectName']) || empty($data['startDate']) || empty($data['endDate']) || empty($data['clientName']) || empty($data['projectHead'])) {
        ...
        $insert = [
            ...
            'seproj_start' => $data['startDate'],
            'seproj_end' => $data['endDate'],
            'seproj_client' => $data['clientName'],
            'seproj_head' => $data['projectHead'],
            'seproj_status' => 'pending',
            'seproj_inf' => $data['description']
        ];
    ...
    public function updateProject($id)
    {
        ...
        $updateData = [
            ...
            'seproj_inf' => $data['description'] // Maps to your seproj_inf column
        ];

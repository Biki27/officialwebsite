...
<body>
    ...
    <div class="employee-container">
        <div class="form-header">
            ...
            <p class="form-subtitle">Complete professional details for new branch employee onboarding</p>
        </div>

        <form id="employeeForm" method="POST"
            action="<?= isset($emp) ? site_url('Manager/updateEmployee/' . $emp->seemp_id) : site_url('Manager/addEmployee') ?>"
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="branch"
                            value="<?= htmlspecialchars($this->session->userdata('branch'), ENT_QUOTES) ?>">
                        <input type="text" class="form-control"
                            value="<?= ucfirst(strtolower($this->session->userdata('branch'))) ?>" disabled
                            style="background-color: #f3f4f6; cursor: not-allowed; color: #6c757d;">
                        <small class="text-muted mt-1 d-block">Locked to your assigned branch.</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="accessLevel" value="EMPL">
                        <input type="text" class="form-control" value="Employee" disabled
                            style="background-color: #f3f4f6; cursor: not-allowed; color: #6c757d;">
                        <small class="text-muted mt-1 d-block">Managers can only create standard employees.</small>
                    </div>

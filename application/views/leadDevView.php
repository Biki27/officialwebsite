            ...
            <div class="row align-items-center flex-column-reverse flex-lg-row g-5">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="skills-wrapper">
                        ...
                        <span class="premium-skill-tag">Node.js</span>
                        <span class="premium-skill-tag">TypeScript</span>
                        <span class="premium-skill-tag">PHP</span>
                        <span class="premium-skill-tag">MySQL</span>
                ...
                <div class="col-lg-6">
                    <div class="premium-exp-card">
                        <h4 class="exp-card-title">
                            <i class="fas fa-briefcase text-primary me-2"></i> Senior Web Developer
                        </h4>
                        <span class="exp-card-subtitle">
                            <strong>Suropriyo Enterprise</strong> &nbsp;•&nbsp; 2022 - Present
                        </span>
                        <ul class="exp-list">
                            <li><i class="fas fa-check-circle"></i> Lead 50+ enterprise web projects</li>
                            <li><i class="fas fa-check-circle"></i> React/Next.js and PHP architecture specialist</li>
                ...
                <div class="col-lg-6">
                    <div class="premium-exp-card">
                        ...
                        <ul class="exp-list achievements mt-n4">
                            ...
                            <li><i class="fas fa-star"></i> First-class service web solutions</li>
                        </ul>
                    </div>
                </div>

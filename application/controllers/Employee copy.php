...
class Employee extends CI_Controller
{
    ...
    public function getEmployeeLeaveSummary($empid)
    {
        ...
        $this->load->model('RequestsModel');
        $this->load->model('EmployeeModel'); // Ensure this is loaded
        ...
        // Fetch the new lifecycle timeline
        $lifecycle = $this->EmployeeModel->get_lifecycle_history($empid);

        echo json_encode([
            'history' => $history,
            'approved_days' => $approved_days,
            'lifecycle' => $lifecycle // Append to response
        ]);
    }

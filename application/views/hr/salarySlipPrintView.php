...
<head>
    ...
    <style>
        ...
        #actionBar .slip-label {
            color: #c7d2fe; font-size: 0.85rem; font-family: Arial, sans-serif;
        }
        #actionBar .slip-label strong { color: #fff; font-size: 1rem; }
        .btn-bar {
        ...
        .btn-bar:hover { opacity: 0.88; }
        .btn-download { background: #4f46e5; color: #fff; }
        .btn-close-bar { background: rgba(255,255,255,0.12); color: #fff; }
        .btn-close-bar:hover { background: rgba(255,255,255,0.22); }
        ...
        @media print {
            ...
            .watermark-bg { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
            .col-header, .net-salary-row th, .totals-row, .round-off-row {
        ...
        body {
            ...
            padding: 70px 20px 20px 20px; /* top pad for action bar */
            box-sizing: border-box;
        }

        .slip-container {
            max-width: 850px; margin: 0 auto;
            border: 2px solid #000; padding: 25px;
        ...
        .header-table, .emp-details, .salary-table,
        .words-row, .signatures { position: relative; z-index: 1; }
        ...
        .emp-details .label  { font-weight: bold; width: 18%; }
        .emp-details .colon  { width: 2%; text-align: center; font-weight: bold; }
        .emp-details .value  { width: 30%; text-transform: uppercase; }
        ...
        .col-header { background-color: #f9f9f9; text-align: left !important; }
        ...
        .round-off-row td:last-child { text-align: right; font-weight: 600; color: #222; }
        ...
        .words-row {
            font-weight: bold; margin-top: 15px; margin-bottom: 50px;

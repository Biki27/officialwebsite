...
<head>
    ...
    <title>Application Received - Suropriyo Enterprise</title>
</head>
                    ...
                    <tr>
                        <td style="padding:50px 40px;">
                            ...
                            <p style="font-size:16px;margin:0 0 25px 0;line-height:1.7;color:#374151;">
                                Thank you for submitting your application for the <strong><?= $position ?></strong> at
                                <strong>Suropriyo Enterprise</strong>.
                            </p>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p style="font-size:15px;margin:0 0 15px 0;line-height:1.6;color:#374151;">
                                            Our hiring team will review your submission and contact you within
                                            <strong>7-10 business days</strong>
                                            if you advance to the next stage.
                                        </p>
                                        <p style="font-size:15px;margin:0;line-height:1.6;color:#374151;">
                                            Feel free to explore our current projects on responsive designs, e-commerce
                                            features,
                                            and Three.js implementations.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                    ...
                                    <td>
                                        ...
                                        <p style="color:#6b7280;font-size:14px;margin:0;">
                                            ...
                                            <a href="mailto:eshitasen07@gmail.com"
                                                style="color:#3b82f6;text-decoration:none;font-weight:500;">eshitasen07@gmail.com</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>

...
<body>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3 mb-4 bg-light p-3 rounded-3 border">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="pay_days" class="form-control form-control-sm" value="30" min="1" max="31" required>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="calc-box">
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        ...
                                        <input type="number" step="0.01" min="0" name="basic" id="calc_basic"
                                            ...
                                            style="width: 150px;" oninput="validity.valid||(value='0');">
                                    </div>
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <span class="small fw-semibold">Transport/House Allowance</span>
                                        <input type="number" step="0.01" min="0" name="transport" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <span class="small fw-semibold">Incentive</span>
                                        <input type="number" step="0.01" min="0" name="incentive" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <span class="small fw-semibold">Overtime/Half Day</span>
                                        <input type="number" step="0.01" min="0" name="overtime" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="small fw-semibold">Round Off</span>
                                        <input type="number" step="0.01" min="0" name="round_off" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="calc-box">
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        ...
                                        <input type="number" step="0.01" min="0" name="pf" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <span class="small fw-semibold">ESI</span>
                                        <input type="number" step="0.01" min="0" name="esi_deduction" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <span class="small fw-semibold">Profession Tax</span>
                                        <input type="number" step="0.01" min="0" name="prof_tax" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <span class="small fw-semibold">Late Fees / NPL</span>
                                        <input type="number" step="0.01" min="0" name="late_fees" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        <span class="small fw-semibold">Loss of Pay / Other</span>
                                        <input type="number" step="0.01" min="0" name="loss_of_pay" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="small fw-semibold">Loan (Office/Bank)</span>
                                        <input type="number" step="0.01" min="0" name="loan" class="form-control form-control-sm text-end calc-input" style="width: 150px;" value="0" oninput="validity.valid||(value='0');">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function calculateTotals() {
            // Helper function to get positive value only
            const getPos = (name) => {
                let val = parseFloat(document.getElementsByName(name)[0].value) || 0;
                return val < 0 ? 0 : val;
            };

            let basic = getPos('basic');
            let trans = getPos('transport');
            let inc = getPos('incentive');
            let over = getPos('overtime');
            let round = getPos('round_off');
            let gross = basic + trans + inc + over + round;

            let pf = getPos('pf');
            let esi = getPos('esi_deduction');
            let prof = getPos('prof_tax');
            let late = getPos('late_fees');
            let lop = getPos('loss_of_pay');
            let loan = getPos('loan');
            let ded = pf + esi + prof + late + lop + loan;

            let net = gross - ded;

            // UI Feedback for Negative Net Salary
            const submitBtn = document.querySelector('button[type="submit"]');
            if (net < 0) {
                document.getElementById('display_net').classList.add('text-warning');
                submitBtn.disabled = true; // Block submission if deductions > earnings
            } else {
                document.getElementById('display_net').classList.remove('text-warning');
